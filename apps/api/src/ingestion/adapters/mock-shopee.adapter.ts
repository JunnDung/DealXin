...
const MOCK_SHOPEE_DEALS: RawDealItem[] = [
  {
    ...
    description:
      "iPhone 16 Pro 256GB Natural Titanium. Chip A18 Pro, Camera 48MP, Pin 4685mAh.",
    ...
    platform: "SHOPEE",
    rawData: {
      shop_name: "Apple Flagship Store VN",
      location: "TP.HCM",
      flash_sale: true,
    },
  },
  {
    ...
    description:
      "Samsung Galaxy S25 Ultra 512GB - Titan Black. Chip Snapdragon 8 Elite, RAM 16GB.",
  ...
  },
  {
    ...
    description:
      "MacBook Air M3 15 inch 256GB - Midnight. Chip M3, RAM 8GB, màn hình Liquid Retina.",
