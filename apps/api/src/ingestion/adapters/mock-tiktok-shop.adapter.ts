...
const MOCK_TIKTOK_DEALS: RawDealItem[] = [
  {
    ...
    description: 'Áo Hoodie nam nữ unisex, chất liệu cotton 300gsm, form rộng oversize.',
  ...
  },
  {
    ...
    description: 'Son kem lì 3CE velvet tint - Bộ 3 màu hot nhất 2026. Lì mịn, bám màu 8h.',
  ...
  },
  {
    ...
    description: 'MacBook Air M2 256GB - Starlight. Chip M2, RAM 8GB, màn hình Retina.',
    ...
    currency: 'VND',
    platform: 'TIKTOK_SHOP',
    rawData: { shop_name: 'Tech Deal VN', live_stream_id: 'ls_123456', views: 50000 },
  },
];
